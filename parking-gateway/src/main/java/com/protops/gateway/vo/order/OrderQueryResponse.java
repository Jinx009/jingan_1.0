 ...
 */
public class OrderQueryResponse extends WeixinPaymentMsg {
    ...
    public void forceRefresh() {
        ...
        setTrade_state(getTrade_state());
        setTrade_state_desc(getTrade_state_desc());
    ...
    public void setTrade_state(String tradeState) {
        ...
        if (!StringUtils.isEmpty(trade_state)) {
            signMap.put("trade_state", trade_state);
        }
    }
    ...
    public void setTrade_state_desc(String trade_state_desc) {
        ...
        if (!StringUtils.isEmpty(trade_state_desc)) {
            signMap.put("trade_state_desc", trade_state_desc);
        }
    }
}
